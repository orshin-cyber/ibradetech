        ...
        <section class="contact_area p_120">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <form class="row contact_form" id="customerMail" novalidate="novalidate">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Enter your name">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="title" name="title" placeholder="Message Subject">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <textarea class="form-control" name="body" id="textarea1" rows="1" placeholder="Enter Message"></textarea>
                                </div>
                            </div>
