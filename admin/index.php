    ...
    <div class="container">
        ...
        <section class="feature_area ">
        	<div class="container mx-auto">
        		...
        		<div class="feature_inner row h-100">
    ...
    object-fit: cover;
        ...
        $query = mysqli_query($conn, $sql);
         ...
         <?php for($page = 1; $page<=$total_pages; $page++){
            echo '<a href="index.php?page='.$page.' " style="cursor:pointer;border:1px solid #ccc; padding:7px;  bottom:10px;" class = "p-2 mb-3 mx-2" >' .$page. "</a>";
         } ?>
         </div>
